...
namespace DouQuqu
{
    ...
    public sealed class BattleCamera : MonoBehaviour
    {
        ...
        public void Fit()
        {
            ...
            float needX = Rules.ArenaHalfWidth + pad;
            float needZ = Rules.ArenaHalfDepth + pad;
        ...
        public Rect ArenaViewNormalized()
        {
            ...
            float arenaWidth = Rules.ArenaHalfWidth * 2f;
            float arenaHeight = Rules.ArenaHalfDepth * 2f;
