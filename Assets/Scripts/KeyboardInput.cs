...
namespace DouQuqu
{
    ...
    /// 透明转发给 LanSession。键盘仅供桌面调试；方向与触屏反弹相同：往后按、朝反方向飞。
    /// </summary>
    public sealed class KeyboardInput : MonoBehaviour
    {
        ...
        private readonly bool[] previousHeld = new bool[MatchController.MaxPlayers];
        ...
        private void Update()
        {
            ...
            int count = Mathf.Clamp(offlinePlayerCount, 1, MatchController.MaxPlayers);
