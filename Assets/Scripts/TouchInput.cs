...
namespace DouQuqu
{
    ...
    public sealed class TouchInput : MonoBehaviour
    {
        ...
        [SerializeField] private LanSession lan;
        [SerializeField] private UIDocument uiDocument;
        [SerializeField] private StickTheme theme;
        ...
        private float stickPx = StickTheme.PrototypeSize;
        private float knobPx = StickTheme.PrototypeKnob;
        private float travelPx = StickTheme.PrototypeTravel;
        ...
        public void BindRuntime(MatchController controller, LanSession session, int localPlayerId)
        {
            match = controller;
            lan = session;
        ...
        private void Awake()
        {
            ...
            if (lan == null) lan = GetComponent<LanSession>();
            if (uiDocument == null) uiDocument = GetComponent<UIDocument>();
            if (theme == null) theme = Resources.Load<StickTheme>("Battle/Stick/StickTheme");
        }
        ...
        private void RefreshStickMetrics()
        {
            ...
            float phoneScale = panelWidth / StickTheme.PrototypePhoneWidth;
            stickPx = (theme != null ? theme.StickSize() : StickTheme.PrototypeSize) * phoneScale;
            knobPx = (theme != null ? theme.KnobSize() : StickTheme.PrototypeKnob) * phoneScale;
            travelPx = (theme != null ? theme.Travel() : StickTheme.PrototypeTravel) * phoneScale;
            float cap = panelWidth * StickTheme.MaxScreenFraction;
