...
namespace DouQuqu
{
    ...
    public sealed class MergeSceneController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (board == null) board = FindObjectOfType<MergeBoard>();
        ...
        {
            PlayerDataService.RecordCricket(result.weightedValue, result.uniformValue);
        }
