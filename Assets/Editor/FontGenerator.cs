...
namespace DouQuqu.Editor
{
    ...
    internal static class FontGenerator
    {
        ...
        private const string DemoCharacters =
            ...
            "，。！？：；（）《》【】·…　/=-+＋%0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz点一下会先打完这句再进入下一新对白做成同目录的用调用把蛐蛐放槽里确定就能开打旁白队长样例对话框说话人揭完全组哦吼年轻人骨骼精奇好才地先借一只玩玩熟悉怎么了嘛听说村子中央超级厉害小铺谁开的回看看秋天农忙花太多时间玩乐所以我专门提供幼虫买各种物品只要给我时得到玉环就行有了去育虫庐培育点击返回你是金色红色绿色蓝色方";
