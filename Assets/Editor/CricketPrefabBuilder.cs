...
namespace DouQuqu.Editor
{
    ...
    /// </summary>
    public static class CricketPrefabBuilder
    {
        ...
        private static void AutoBuildIfMissing()
        {
            EditorApplication.delayCall += () =>
            {
                ...
                if (File.Exists(CricketSkeletalBuilder.PsbPath)) return;
        ...
        {
            CricketSkeletalBuilder.Rebuild();
        }
        ...
        public static void RebuildPlaceholder()
        {
            ...
            CricketArtImporter.ReimportIfNeeded();
        ...
        private static void BuildPrefab(Sprite bodySprite, Sprite antennaSprite, Material outline)
        {
            ...
            try
            {
                ...
                if (visual == null) visual = root.AddComponent<CricketVisual>();
