...
namespace DouQuqu.Editor
{
    ...
    internal static class DouQuquFontGenerator
    {
        ...
        private const string DemoCharacters =
            "斗蟋蟀演示输入名称后登录成功主界面玩家按钮合成匹配图鉴退出返回局域网计时开始取消正在搜索等待槽位机器人进入游戏结束胜利你是本局赢家获胜者还没有前往将两只二级棋子到三级即可获得拖动它同等级棋盘满先空格完成抽卡结果操作最高级请将内松手必须是没有移动已取消分数最近生成并从消失保底进度按住蓄力合成完成获得道具当前等级点搜索秒成功剩余时间即将开放育虫盘图鉴活动排行商店学院金币规则背包放卵幼虫中虫成虫精品凡品灵品仙品极品强攻灵巧智谋沉稳" +
