...
namespace DouQuqu.Editor
{
    ...
    /// </summary>
    public static class BodyPrefabBuilder
    {
        ...
        {
            new BodyEntry("Assets/Resources/Battle/Entities/Textures/QingTou.svg", "Assets/Resources/Battle/Entities/Prefabs/QingTou.prefab", 20),
            new BodyEntry("Assets/Resources/Battle/Entities/Textures/YouHulu.svg", "Assets/Resources/Battle/Entities/Prefabs/YouHulu.prefab", 20),
            new BodyEntry("Assets/Resources/Battle/Entities/Textures/Baby.svg", "Assets/Resources/Battle/Entities/Prefabs/Baby.prefab", 18)
        };
        ...
        public static void Rebuild()
        {
            ...
            AssetDatabase.Refresh();
            Debug.Log("[DouQuqu] 身体预制体已重建：" + built + "/" + Entries.Length + "。玩法碰撞仍是半径 " + Rules.DefaultKnobs().bugR + " 的圆，视觉会按直径对齐。");
        }
        ...
        private static void AssignToOpenScene()
        {
            ...
            if (!System.IO.File.Exists(CricketPrefabBuilder.PrefabPath))
            {
                SetPrefab(so, "bugPrefab", "Assets/Resources/Battle/Entities/Prefabs/QingTou.prefab");
                SetPrefab(so, "qingTouPrefab", "Assets/Resources/Battle/Entities/Prefabs/QingTou.prefab");
                SetPrefab(so, "youHuluPrefab", "Assets/Resources/Battle/Entities/Prefabs/YouHulu.prefab");
            }
            SetPrefab(so, "babyPrefab", "Assets/Resources/Battle/Entities/Prefabs/Baby.prefab");
