...
namespace UnityFigmaBridge.Editor
{
    ...
    public class FigmaImportProcessData
    {
        ...
        /// <summary>
        /// When true, only selected frames and required components are generated
        /// </summary>
        public bool RestrictToSelectedNodes;

        /// <summary>
        /// Explicitly selected node ids (frames/components/instances)
        /// </summary>
        public HashSet<string> SelectedNodeIds = new();

        /// <summary>
        /// Component ids required by the selected nodes, including nested components
        /// </summary>
        public HashSet<string> RequiredComponentIds = new();
